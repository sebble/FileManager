...
function filetype(filename) {
    ...
    if (filename.match(/\.(c|css|js|m|sh)$/)) return 'code';   //f121
    ...
    'note'  : 'icon-calendar',
        ...
        */
        ...
        case 'text':
            ...
            break;
        case 'code': // syntax highlight (eventually) -- highlight.js or CodeMirror2 ?
            content = fetch(url);
            html = '<pre>'+content+'</pre>';
            break;
        case 'image':
...
function resizeView() {
    ...
    var padding = (isDepth-1) * 2 + (1-isFile) * 23.5;// + 8;
