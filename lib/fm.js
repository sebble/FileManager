...
function filetype(filename) {
    ...
    if (filename.match(/\.(bat|c|css|js|json|m|sh|py)$/)) return 'code';   //f121
    ...
    if (filename.match(/\.(ipynb)$/)) return 'ipynb';
    return 'file';
}
...
function navigateTo(path) {
    ...
    animateTo(path);
    // udpate page title
    $(document).attr('title',theProject+thePath+' - FileManager');
}
    ...
    */
    ...
    what about sourceMakeup or docco?
        ...
        */
        ...
        case 'note':
        case 'text':
            html = '<iframe src="//my.sbl.io/raw/projects/file-browser/lib/markdown.html#'+url+'"></iframe>';
            break;
        case 'book':
            content = fetch(url);
